...
# Equal <span class="ml-1 px-2 py-1 text-sm text-gray-600 (dark)text-charcoal-100 bg-gray-300 (dark)bg-gray-600">v1.0.8</span>
...
| equal-x-72 <span class="ml-1 px-2 py-1 text-sm text-gray-600 (dark)text-charcoal-100 bg-gray-300 (dark)bg-gray-600">v1.1.3</span> | --equal-x-reverse: 0; <br> margin-right: calc(18rem * var(--equal-x-reverse)); <br> margin-left: calc(18rem * calc(1 - var(--equal-x-reverse))) |
| equal-x-80 <span class="ml-1 px-2 py-1 text-sm text-gray-600 (dark)text-charcoal-100 bg-gray-300 (dark)bg-gray-600">v1.1.3</span> | --equal-x-reverse: 0; <br> margin-right: calc(20rem * var(--equal-x-reverse)); <br> margin-left: calc(20rem * calc(1 - var(--equal-x-reverse))) |
| equal-x-88 <span class="ml-1 px-2 py-1 text-sm text-gray-600 (dark)text-charcoal-100 bg-gray-300 (dark)bg-gray-600">v1.1.3</span> | --equal-x-reverse: 0; <br> margin-right: calc(22rem * var(--equal-x-reverse)); <br> margin-left: calc(22rem * calc(1 - var(--equal-x-reverse))) |
| equal-x-96 <span class="ml-1 px-2 py-1 text-sm text-gray-600 (dark)text-charcoal-100 bg-gray-300 (dark)bg-gray-600">v1.1.3</span> | --equal-x-reverse: 0; <br> margin-right: calc(24rem * var(--equal-x-reverse)); <br> margin-left: calc(24rem * calc(1 - var(--equal-x-reverse))) |
...
| -equal-x-104 <span class="ml-1 px-2 py-1 text-sm text-gray-600 (dark)text-charcoal-100 bg-gray-300 (dark)bg-gray-600">v1.1.3</span> | --equal-x-reverse: 0; <br> margin-right: calc(-26rem * var(--equal-x-reverse)); <br> margin-left: calc(-26rem * calc(1 - var(--equal-x-reverse))) |
| -equal-x-112 <span class="ml-1 px-2 py-1 text-sm text-gray-600 (dark)text-charcoal-100 bg-gray-300 (dark)bg-gray-600">v1.1.3</span> | --equal-x-reverse: 0; <br> margin-right: calc(-28rem * var(--equal-x-reverse)); <br> margin-left: calc(-28rem * calc(1 - var(--equal-x-reverse))) |
| equal-y-px | --equal-y-reverse: 0; <br> margin-top: calc(1px * calc(1 - var(--equal-y-reverse))); <br> margin-bottom: calc(1px * var(--equal-y-reverse)) |
...
| equal-y-72 <span class="ml-1 px-2 py-1 text-sm text-gray-600 (dark)text-charcoal-100 bg-gray-300 (dark)bg-gray-600">v1.1.3</span> | --equal-y-reverse: 0; <br> margin-top: calc(18rem * calc(1 - var(--equal-y-reverse))); <br> margin-bottom: calc(18rem * var(--equal-y-reverse)) |
| equal-y-80 <span class="ml-1 px-2 py-1 text-sm text-gray-600 (dark)text-charcoal-100 bg-gray-300 (dark)bg-gray-600">v1.1.3</span> | --equal-y-reverse: 0; <br> margin-top: calc(20rem * calc(1 - var(--equal-y-reverse))); <br> margin-bottom: calc(20rem * var(--equal-y-reverse)) |
| equal-y-88 <span class="ml-1 px-2 py-1 text-sm text-gray-600 (dark)text-charcoal-100 bg-gray-300 (dark)bg-gray-600">v1.1.3</span> | --equal-y-reverse: 0; <br> margin-top: calc(22rem * calc(1 - var(--equal-y-reverse))); <br> margin-bottom: calc(22rem * var(--equal-y-reverse)) |
| equal-y-96 <span class="ml-1 px-2 py-1 text-sm text-gray-600 (dark)text-charcoal-100 bg-gray-300 (dark)bg-gray-600">v1.1.3</span> | --equal-y-reverse: 0; <br> margin-top: calc(24rem * calc(1 - var(--equal-y-reverse))); <br> margin-bottom: calc(24rem * var(--equal-y-reverse)) |
