...
| rotate-z-30 | --transform-rotate-z: 30deg |
...
| rotate-z-100 | --transform-rotate-z: 100deg |
...
<y class="my-6 mx-auto w-32">
  <y class="h-48 w-48 bg-red-300 flex justify-center items-center">
    <img
      class="h-32 w-32 transform rotate-0 rounded shadow"
...
<!-- Example -->
<img
  class="transform rotate-0 ... h-32 w-24"
  src="..."
>
...
<!-- Example -->
<img
  class="transform rotate-45 ... h-32 w-24"
  src="..."
>
...
<!-- Example -->
<img
  class="transform rotate-90 ... h-32 w-24"
  src="..."
>
...
<!-- Example -->
<img
  class="transform rotate-180 ... h-32 w-24"
  src="..."
>
