...
export default async () => {
  ...
  function renderSearchResult(searchTerm, result) {
    ...
    return `
      <a class="(group) z-10 search-result block mb-2 p-5 outline-none border-4 border-transparent (focus)border-gray-800 text-gray-800 bg-gray-100 (hover)bg-gray-800 rounded-lg"
         href="${result.url}"
         target="_self"
         rel="noopener">
